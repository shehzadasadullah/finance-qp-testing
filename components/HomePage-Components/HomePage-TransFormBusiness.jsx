...
function HomePageTransFormBusiness() {
  return (
    <div className="w-full px-2 lg:px-4">
      <div className="rounded-[16px] my-8 md:pt-5 w-full">
        <div className="flex p-5 md:pt-0 md:pl-[40px] gap-5 md:pr-[40px] justify-center items-center flex-col md:flex-row w-full">
            ...
            <div className="w-full flex md:justify-between justify-center flex-col md:flex-row items-center">
              <div className="w-full flex md:justify-start justify-center items-center flex-col">
                <div className="w-full text-center md:text-start il-industries-serve">
                  In-House Terms Cost You More Than You Think, See Why Your
                  In-House Terms Could Be Costing You Clients
                </div>
                <div className="w-full mt-0 md:mt-1 mb-3 md:mb-0 text-center md:text-start il-industries-serve-sub">
                  Our Data Shows How Harvv Delivers Better Results and Faster
                  Growth and Why Harvv Is a Smarter, More Profitable Choice.
                </div>
              </div>
            </div>
            <div className="w-full flex justify-center md:justify-start items-center">
              <button className="il-view-all-button w-full md:w-40">
                Let's Chat
              </button>
            </div>
          </div>
...
export default HomePageTransFormBusiness;
