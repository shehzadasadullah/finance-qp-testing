...
function WhyHarvv() {
  ...
  const slides = [
    ...
    },
    {
      ...
      subHeading:
        "arvv provides financing without requiring personal guarantees, allowing you to secure capital without risking personal assets. This ensures peace of mind and protects what matters most.",
      bgSrc: img5.src,
    },
  ];
